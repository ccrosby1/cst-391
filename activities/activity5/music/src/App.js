...
const App = () => {
  const [albumList, setAlbumList] = useState([
    ...
    },
    {
      ...
      title: 'Abbey Road',
      description:
        'Abbey Road is the eleventh studio album by the English rock band the Beatles, released on 26 September 1969, by Apple Records. It is the last album the group recorded, although Let It Be was the last album completed before the bands break-up in April 1970.',
      year: 1969,
      image:
